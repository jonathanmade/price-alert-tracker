    ...
    <>
      ...
      <div className="bg-white border-b border-gray-100 px-8 py-4 flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-gray-400 mt-0.5">Alertas disparadas y pausadas</p>
        </div>
      </div>
                ...
                {isExpanded && (
                  <div className="px-6 pb-6 border-t border-gray-50">
                    ...
                    <a
                      ...
                      className="inline-block mt-4 text-xs text-indigo-600 hover:text-indigo-800 transition-colors"
                    >
                      Ver producto →
                    </a>
                  </div>
